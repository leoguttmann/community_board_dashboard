...
aws s3 cp s3://qcb2-dashboard-data-store/summaryvotelog/ ~/Downloads/tonightsvotes/summary/  --recursive --exclude "*" --include "2024_01_02*" --include "2024_01_03*"
aws s3 cp s3://qcb2-dashboard-data-store/rawvotelog/ ~/Downloads/tonightsvotes/raw/ --recursive --exclude "*" --include "2024_01_02*" --include "2024_01_03*"
